...
// The official sample this file is adapted from calls `Logger.getLogger(...)`
// here without importing `Logger` anywhere — side-service context has no
// confirmed global by that name (unlike device-side's `@zos/utils` log
// export). Use a plain console-based logger instead of risking a
// ReferenceError on the very first message send.
function initLogger() {
  logger = {
    log: (...a) => console.log('[side-message]', ...a),
    debug: (...a) => console.log('[side-message]', ...a),
    warn: (...a) => console.log('[side-message]', ...a),
    error: (...a) => console.log('[side-message]', ...a),
  }
}
